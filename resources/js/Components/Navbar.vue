            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="flex flex items-center space-x-2">
                        ...
                        <Link :href="route('user.index')" class="flex">
                        <p>Users</p>
                        </Link>
                    </div>
                </div>
                                ...
                                <template #content>
                                    <div
                                        ...
                                        <span class="flex items-center justify-start text-sm truncate">
                                            {{ $page.props.auth.user.name }}
                                            <CheckBadgeIcon class="ml-[2px] w-4 h-4 dark:text-white text-primary" v-show="$page.props.auth.user
                                                .email_verified_at
                                                " />
                                        </span>
                                        <span class="block text-sm font-medium text-slate-500 truncate dark:text-slate-400">
                                            {{
