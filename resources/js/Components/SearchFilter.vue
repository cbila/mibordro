<template>
  <div class="flex items-center">
    <div class="flex w-full bg-white rounded shadow mr-4">
      <dropdown :auto-close="false"
        ...
        <template #default>
          <div class="flex items-baseline">
            <span class="hidden text-gray-700 md:inline">Filtre</span>
      ...
      <input class="relative px-6 py-3 w-full rounded-r focus:shadow-outline" autocomplete="off" type="text" name="search"
        placeholder="Ara..." :value="modelValue" @input="$emit('update:modelValue', $event.target.value)" />
    </div>
    <!-- <button class="" type="button" @click="$emit('reset')">Sıfırla</button> -->
  </div>
</template>
