<template>
    <transition name="slide-fade">
        <div v-if="flash.success && isVisible" class="fixed top-8 right-8 w-8/12 md:w-6/12 lg:w-3/12 z-[100]">
    ...
    <transition name="slide-fade">
        <div v-if="flash.info && isVisible" class="fixed top-8 right-8 w-8/12 md:w-6/12 lg:w-3/12 z-[100]">
    ...
    <transition name="slide-fade">
        <div v-if="flash.warning && isVisible" class="fixed top-8 right-8 w-8/12 md:w-6/12 lg:w-3/12 z-[100]">
    ...
    <transition name="slide-fade">
        <div v-if="flash.error && isErrorVisible" class="fixed top-8 right-8 w-8/12 md:w-6/12 lg:w-3/12 z-[100]">
