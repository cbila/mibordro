...
return [
    'label' => [
        ...
        'delete_doc_confirm' => 'Are you sure to delete',
        ...
        'uploaded_successfully' => '<b>:name</b> uploaded successfully.',
        'uploaded_error' => 'Error deleting :name.',
        ...
        'phone' => 'Phone',
        'contact' => 'Contact',
        'holidays' => 'Remaining off days',
        'info' => 'User Info',
        'alias' => 'Filename',
        'mailType' => 'E-mail Type',
    ...
    'placeholder' => [
        ...
        'gsm' => 'Phone',
        'guard_name' => 'Guard',
        'alias' => 'max 100 chars, no extension',
    ...
    'profile' => [
        ...
        'update_profile' => "You must verify your e-mail address when changed.",
